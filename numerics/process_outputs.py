...
# %%
bench_list = [
    'exp_mean_sin_exp_cos_d_8_m_1',
    'exp_mean_sin_exp_cos_d_8_m_2',
    'borehole_d_8_m_1',
    'borehole_d_8_m_2',
    'sin_squared_norm_d_8_m_1',
    'sin_squared_norm_noscale_d_8_m_1',
    'sum_cos_sin_squared_norm_d_8_m_2',
    ]
